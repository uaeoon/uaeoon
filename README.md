...
- 금융 정보를 기반으로 한 Peer Matching 및 자산 Benchmark 계산 로직 구현
- 자산 집중도·부채 부담 등을 반영한 위험 점수 산출 및 OpenAI 분석 API 구현
- Peer 카드 조회와 사용자 간 1:1 금융 정보 비교 API 구현
- Docker·GitHub Actions·AWS EC2 기반 CI/CD 및 자동 배포 환경 구축
...
- Spring Security와 JWT 기반 인증·인가 및 회원 관리 API 구현
- 개인·팀 일정과 마일스톤을 제공하는 통합 캘린더 API 구현
